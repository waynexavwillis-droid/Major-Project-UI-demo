...
const App: React.FC = () => {
    ...
    <div className="relative h-full p-4 pb-36 animate-fade-in flex flex-col gap-6">
      ...
      <div className="grid grid-cols-3 gap-3 relative z-10 shrink-0">
        <div className="bg-white dark:bg-zinc-900/80 p-4 rounded-[30px] border border-zinc-100 dark:border-zinc-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-lg flex flex-col justify-between group hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="text-zinc-400 dark:text-zinc-500 text-[10px] font-mono uppercase tracking-widest mb-2">Total Fleet</div>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar">
                <div className="divide-y divide-zinc-100 dark:divide-zinc-800/50">
                    {dashboardList.length === 0 ? (
                        <div className="p-12 text-center text-zinc-400 dark:text-zinc-500 text-xs font-mono">No assets detected in sector.</div>
                    ) : (
                        dashboardList.map(t => (
  ...
  return (
    <div className={`${isDarkMode ? 'dark' : ''} h-full`}>
                ...
                <div className="bg-white dark:bg-zinc-900 w-full max-w-xs rounded-[30px] p-6 border border-zinc-200 dark:border-zinc-800 shadow-2xl animate-slide-up" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="space-y-4 mb-6">
                        <div>
                            ...
                            <select 
                                className="w-full bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-[20px] px-3 py-2.5 text-sm text-zinc-900 dark:text-white outline-none focus:border-lime-500"
                                value={newBeaconZone}
        ...
        {/* Floating Dock Navigation - Replaced old bar with this centered capsule */}
